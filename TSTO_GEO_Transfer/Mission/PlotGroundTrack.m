...
function PlotGroundTrack(S,String,Color)
    ...
    Title = title('Example 2 Groundtrack','Color','w','FontSize',20,'Parent',Axes);
    ...
    for k = 1:2:n
        ...
        text(S(k).Long(1),-S(k).Lat(1) - 5^(0.75/k), str(k), 'Color', 'w');
